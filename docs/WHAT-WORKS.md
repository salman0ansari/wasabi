...
This page describes the shipped behavior in wasabi `0.3.4`. It is a capability inventory, not a promise about unfinished controls. Features without a complete data source, failure state, and usable workflow stay hidden.
